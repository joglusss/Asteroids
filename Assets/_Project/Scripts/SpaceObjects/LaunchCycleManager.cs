...
namespace Asteroids.Objects
{
    public class LaunchCycleManager : MonoBehaviour, IInitializable
    {
        ...
        {
            LaunchCycle(_asteroidQueue, _config.Asteroids, this.GetCancellationTokenOnDestroy()).Forget();
            LaunchCycle(_alienQueue, _config.Alien, this.GetCancellationTokenOnDestroy()).Forget();
        }
        ...
        private async UniTask LaunchCycle(SpaceObjectQueue objQueue, LaunchCycleSetting setting, CancellationToken token)
        {
